...
if (strlen($_SESSION['login']) == 0) {
  ...
  <body id="body">
    ...
    <main id="main">
          ...
          <nav aria-label="Page navigation example" class="pagination d-flex justify-content-center">
            <ul class="pagination d-flex justify-content-center">
              ...
              <li class="page-item <?php echo $page >= $totalPages ? 'disabled' : ''; ?>">
                <a class="page-link" href="<?php echo $page >= $totalPages ? '#' : '?page=' . ($page + 1); ?>"
                  aria-label="Next">
      ...
      <div class="modal fade" id="tcWithDriverModal" tabindex="-1" role="dialog" aria-labelledby="tcWithDriverModalLabel"
        aria-hidden="true">
