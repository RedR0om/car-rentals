...
if (strlen($_SESSION['alogin']) == 0) {
	...
	if (isset($_POST['update'])) {
		...
		$sql = "update tblbanner set Vimage1=:vimage1 where id=:id";
	...
	<head>
		...
		<title>Car Rental Portal | Staff Update Image 1</title>
										...
										<div class="panel-body">
											<form method="post" class="form-horizontal" enctype="multipart/form-data">
												...
												<div class="form-group">
													...
													<?php
													$id = intval($_GET['imgid']);
													$sql = "SELECT Vimage1 from tblbanner where tblbanner.id=:id";
													$query = $dbh->prepare($sql);
													$query->bindParam(':id', $id, PDO::PARAM_STR);
													$query->execute();
													...
													if ($query->rowCount() > 0) {
														foreach ($results as $result) { ?>
															...
															<div class="col-sm-8">
																<img src="img/bannerimages/<?php echo htmlentities($result->Vimage1); ?>"
