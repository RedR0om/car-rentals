...
<body id="body"> 
 ...
 <section id="innerBanner" style="background: black;"> 
  <div class="inner-content">
    <h2><span style="color: #009bc2">Search Result of keyword "<?php echo $_POST['searchdata'];?>"</span><br>We provide high quality cars!</h2>
    <div> 
    </div>
  </div> 
</section><!-- #Page Banner -->
      ...
      <div class="col-md-9 col-md-push-3">
        <div class="result-sorting-wrapper">
          <div class="sorting-count">
            ...
            where tblvehicles.VehiclesTitle=:search || tblvehicles.FuelType=:search || tblbrands.BrandName=:search || tblvehicles.ModelYear=:search || tblvehicles.SeatingCapacity=:search";
