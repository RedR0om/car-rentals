...
.mySlides {display: none; width:100%; height : 40%;}
img {
...
<div class="mySlides fade">
  <img src="slide1.jpg" style="width:100% height : 40%">
  <div class="text">Caption Text</div>
</div>

<div class="mySlides fade">
  <img src="slide2.jpg" style="width:100% height: 40%">
  <div class="text">Caption Two</div>
</div>

<div class="mySlides fade">
  <img src="slide3.jpg" style="width:100% height:40%">
  <div class="text">Caption Three</div>
</div>

<div class="mySlides fade">
  <img src="slide4.jpg" style="width:100% height: 40%">
  <div class="text">Caption Three</div>
</div>

<div class="mySlides fade">
  <img src="slide5.jpg" style="width:100% height: 40%">
  <div class="text">Caption Three</div>
</div>
...
function showSlides() {
  ...
  setTimeout(showSlides, 2000); // Change image every 2 seconds
    ...
    <div class="section-header text-center" style="width: 60%; margin-top: -70%; text-align: justify;" >


      <h2><center><?php   echo htmlentities($result->PageName); ?></center></h2>
  ...
  <div class="container div_zindex">
    <div class="row">
      ...
      <div class="col-lg-3 col-xs-6 col-sm-3">
        <div class="fun-facts-m">
          <div class="cell">
            <h2><i class="fa fa-user-circle-o" aria-hidden="true"></i>1 +</h2>
