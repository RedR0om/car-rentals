            ...
            <div class="fw-recent">
              <form method="post">
                ...
                <button type="submit" name="emailsubscibe" class="btn btn-block"
                  style="font-family:'Tahoma',sans-serif">Subscribe <span class="angle_arrow"><i
                      class="fa fa-angle-right" aria-hidden="true"></i></span></button>
              </form>
              <p class="subscribed-text" style="font-family:'Tahoma',sans-serif">*We send great deals and latest auto
                news
