                                ...
                                <div class="box wow  fadeInLeft" style="width:104%; height: 87.8%;">
                                    <div class="car-info-box">
                                        <a href="car_details.php?vhid=<?php echo htmlentities($result->id); ?>">
                                            <img src="admin/img/vehicleimages/<?php echo !empty($car->Vimage1) ? htmlentities($car->Vimage1) : '1audiq8.jpg'; ?>" alt="image" style="height: 180px; border-bottom:  solid; border-color: #fa2837b3; width: 290px; max-height: 180px;">
