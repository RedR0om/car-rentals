...
$cnum=$_POST['cnum'];
$id=$_GET['id'];
$sql="update staff set cnum=:cnum where id=:id";
...
<?php	
$id=$_GET['id'];
$ret="select * from staff where id=:id";
...
?>
											...
											<div class="form-group">
												...
												<div class="col-sm-8">
													<input type="text" class="form-control" value="<?php echo htmlentities($result->cnum);?>" name="cnum" id="cnum" required>
												</div>
											</div>
