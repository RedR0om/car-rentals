...
.gmail a:hover, a:active {
  background-color: blue;
}
</style>
				<div class="gmail">
<a href="https://mail.google.com/mail/u/0/" target="_blank"><i class="	fa fa-envelope" aria-hidden="true"></i> Open Gmail</a>
</div>
<br>
...
{
	?><td>Read<a>/<a>
<a href="manage-conactusquery.php?del=<?php echo $result->id;?>" onclick="return confirm('Do you want to delete');"><i class="fa fa-close"></i></a></td></td>
<?php } else {?>
