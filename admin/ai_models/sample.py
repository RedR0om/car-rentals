...
data = pd.DataFrame({
    'ds': [
        '2024-10-01', '2024-10-03', '2024-10-06', '2024-10-09', '2024-10-12',
    ...
    'y': [
        5, 3, 6, 2, 7, 4, 8, 9, 5, 6, 4, 7, 1, 9, 3, 5, 6, 8, 2, 7,
...
# Apply a slight randomization to 'ds' and 'y'
...
# Create future dataframe (next 60 days) and get the forecast
future = model.make_future_dataframe(periods=60)
forecast = model.predict(future)

# Find the next maintenance date based on the highest predicted 'yhat' after the latest known date
...
# Filter forecast for the actual data range and calculate error metrics
