                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <!-- New Reservation Application Table -->
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="panel panel-default">
                                        <div class="panel-heading">New Reservation Application</div>
                                        <div class="panel-body">
                                            ...
                                            WHERE tblbooking.Status = 0 
                                            AND MONTH(tblbooking.PostingDate) = MONTH(CURDATE())
                                            ORDER BY 
                                                tblbooking.Status ASC,
                                                tblbooking.PostingDate DESC
                                            LIMIT 20";
